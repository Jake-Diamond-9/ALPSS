...
pb_neighbors:               integer; number of neighbors to compare to when searching
                                     for the pullback local minimum
pb_idx_correction:          integer; number of local minima to adjust by if the program grabs the wrong one
rc_neighbors:               integer; number of neighbors to compare to when searching
                                     for the recompression local maximum
rc_idx_correction:          integer; number of local maxima to adjust by if the program grabs the wrong one
...
alpss_main(filename="F2--20220128--00007.txt",
           save_data='yes',
